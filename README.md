...
### Option A — Auto-setup (recommended, macOS/Linux)

1. **Install the extension** in VS Code:
   ```
   Cmd+Shift+P → "Extensions: Install from VSIX" → extension/quotely-1.2.0.vsix
   ```
...
```bash
# Clone the repo
git clone https://github.com/your-username/quotely.git
cd quotely

# Install backend + models + configure VS Code (macOS/Linux only)
bash setup.sh
```

Then install the extension from `extension/quotely-1.2.0.vsix`.

> **Requirements:**  Python 3.10+, macOS or Linux (Windows support coming soon).
