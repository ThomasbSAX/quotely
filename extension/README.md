...
Install from this page. On first launch, Quotely installs its Python backend automatically (~5 minutes, one time only). You only need **Python 3.8+** on your machine.
...
[Source on GitHub](https://github.com/ThomasbSAX/quotely) · MIT License
